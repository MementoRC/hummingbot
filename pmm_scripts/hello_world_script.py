...
class HelloWorldPMMScript(PMMScriptBase):
    ...
    def __init__(self):
        ...
        self.oracles = [RateOracleSource.kucoin, RateOracleSource.gate_io, RateOracleSource.ascend_ex,
    ...
    def print_rates(self, source: RateOracleSource):
        # RateOracle.source = source
        if self.rate_future:
