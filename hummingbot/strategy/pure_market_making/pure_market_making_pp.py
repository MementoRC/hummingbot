...
from .inventory_skew_calculator import calculate_bid_ask_ratios_from_base_asset_ratio, calculate_total_order_size
...
class PureMarketMakingStrategyPurePython(StrategyPyBase):
    ...
    def to_create_orders(self, proposal):
        non_hanging_orders_non_cancelled = [o for o in self.active_non_hanging_orders if not self._hanging_orders_tracker.is_potential_hanging_order(o)]
