...
# Base URL
REST_URL = "https://api3.loopring.io/api/"
WSS_URL = "wss://ws.api3.loopring.io/v3/ws"
...
EXCHANGE_INFO_PATH_URL = "/exchange/info"
...
RATE_LIMITS = [
    # Pools
    RateLimit(limit_id=ORDERS, limit=5, time_interval=ONE_SECOND),
