...
class PerformanceMetricsUnitTest:
    ...
    def test_performance_metrics(self):
        ...
        assert Decimal("799") == metrics.trade_pnl
        print(metrics)
    ...
    def test_performance_metrics_for_derivatives(self, is_trade_fill_mock):
        ...
        assert metrics.num_sells == 2
        assert metrics.num_trades == 4
        assert metrics.b_vol_base == Decimal("200")
        assert metrics.s_vol_base == Decimal("-200")
        assert metrics.tot_vol_base == Decimal("0")
        assert metrics.b_vol_quote == Decimal("-2500")
        assert metrics.s_vol_quote == Decimal("3500")
        assert metrics.tot_vol_quote == Decimal("1000")
        assert metrics.avg_b_price == Decimal("12.5")
        assert metrics.avg_s_price == Decimal("17.5")
        assert metrics.avg_tot_price == Decimal("15")
        assert metrics.start_base_bal == Decimal("100")
        assert metrics.start_quote_bal == Decimal("9000")
        assert metrics.cur_base_bal == 100
    ...
    def test_smart_round(self):
        ...
        assert value == Decimal("0.00005678")
    ...
    def test__process_deducted_fees_impact_in_quote_vol(self):
        ...
        assert returned_impact == Decimal("-100.0")
