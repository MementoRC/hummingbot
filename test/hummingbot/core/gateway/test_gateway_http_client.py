...
class GatewayHttpClientUnitTest(unittest.IsolatedAsyncioTestCase):
    _db_path: str
    ...
    def setUpClass(cls) -> None:
        ...
        GatewayHttpClientUnitTest._patch_stack.enter_context(
            GatewayHttpClientUnitTest._http_player.patch_aiohttp_client())
