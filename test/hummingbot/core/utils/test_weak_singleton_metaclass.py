...
class TestWeakSingletonMetaclass(unittest.TestCase):
    ...
    def test__class_is_instantiated(self):
        ...
        self.assertFalse(ClassA.is_class_instantiated(ClassA))
        self.assertFalse(SubclassA.is_class_instantiated(SubclassA))

        a = ClassA()
        self.assertTrue(ClassA.is_class_instantiated(ClassA))
        self.assertFalse(SubclassA.is_class_instantiated(SubclassA))
        self.assertTrue(a.__class__.is_class_instantiated(a.__class__))

        b = SubclassA()
        self.assertTrue(ClassA.is_class_instantiated(ClassA))
        self.assertTrue(SubclassA.is_class_instantiated(SubclassA))
        self.assertTrue(a.__class__.is_class_instantiated(a.__class__))
        self.assertTrue(b.__class__.is_class_instantiated(b.__class__))
    ...
    def test__lock_reentrant(self):
        ...
        self.assertTrue(self.SingletonClass.is_class_instantiated(self.SingletonClass))
        ...
        with lock:
            ...
            self.assertFalse(self.SingletonClass.is_class_instantiated(self.SingletonClass))
    ...
    def test__lock_reentrant_thread(self):
        ...
        # Check that subclasses of a singleton class are different singletons
        SingletonClass(0)
        self.assertTrue(SingletonClass.is_class_instantiated(SingletonClass))
    ...
    def test__lock_reentrant_thread_on_dead_instance(self):
        ...
        with lock:
            del a
            self.assertFalse(SingletonClass.is_class_instantiated(SingletonClass))
