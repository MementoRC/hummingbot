...
class BinanceUserStreamDataSourceUnitTests(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_get_listen_key_log_exception(self, mock_api):
        ...
        with self.assertRaises(IOError):
            await self.async_run_with_timeout(self.data_source._get_listen_key())
    ...
    async def test_get_listen_key_successful(self, mock_api):
        ...
        result: str = await self.async_run_with_timeout(self.data_source._get_listen_key())
    ...
    async def test_ping_listen_key_log_exception(self, mock_api):
        ...
        result: bool = await self.async_run_with_timeout(self.data_source._ping_listen_key())
    ...
    async def test_listen_for_user_stream_get_listen_key_successful_with_user_update_event(self, mock_api, mock_ws):
        ...
        msg = await self.async_run_with_timeout(msg_queue.get())
