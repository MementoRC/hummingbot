...
class BtcMarketsAPIUserStreamDataSourceTest(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_listen_for_user_stream_logs_error_when_login_fails(self, ws_connect_mock):
        ...
        self.listening_task = asyncio.create_task(self.data_source.listen_for_user_stream(output=output_queue))
    ...
    #     try:
    #         await self.async_run_with_timeout(self.listening_task, timeout=3)
    #     except asyncio.CancelledError:
    #         pass
    ...
    async def test_listen_for_subscriptions_subscribes_to_order_change_fund_change(self, ws_connect_mock):
        ...
        self.listening_task = asyncio.create_task(self.data_source.listen_for_user_stream(asyncio.Queue()))
