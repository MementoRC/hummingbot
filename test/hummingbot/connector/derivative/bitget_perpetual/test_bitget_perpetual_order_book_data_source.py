...
class BitgetPerpetualAPIOrderBookDataSourceTests(IsolatedAsyncioTestCase):
    ...
    async def test_get_new_order_book_successful(self, mock_api):
        ...
        order_book = await self.async_run_with_timeout(
    ...
    async def test_listen_for_subscriptions_for_usdc_product_type_pair(self, ws_connect_mock):
        ...
        self.listening_task = asyncio.create_task(local_data_source.listen_for_subscriptions())
    ...
    async def test_listen_for_order_book_snapshots_cancelled_when_fetching_snapshot(self, mock_api):
        ...
        with self.assertRaises(asyncio.CancelledError):
            await self.async_run_with_timeout(
                self.data_source.listen_for_order_book_snapshots(None, asyncio.Queue())
            )
    ...
    async def test_listen_for_order_book_snapshots_log_exception(self, mock_api):
        ...
        try:
            await self.async_run_with_timeout(self.listening_task, 5)
        except asyncio.CancelledError:
            pass
    ...
    async def test_listen_for_funding_info_logs_exception(self):
        ...
        self.listening_task = asyncio.create_task(self.data_source.listen_for_funding_info(msg_queue))
    ...
    async def test_listen_for_funding_info_successful(self):
        ...
        msg: FundingInfoUpdate = await self.async_run_with_timeout(msg_queue.get())
    ...
    async def test_get_funding_info(self, mock_api):
        ...
        funding_info: FundingInfo = await self.async_run_with_timeout(
