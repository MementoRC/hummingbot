...
class TestGateIoPerpetualAPIUserStreamDataSource(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_listen_for_user_stream_connection_failed(self, sleep_mock, mock_ws):
        ...
        msg_queue = asyncio.Queue()
        try:
            await self.async_run_with_timeout(self.data_source.listen_for_user_stream(msg_queue))
