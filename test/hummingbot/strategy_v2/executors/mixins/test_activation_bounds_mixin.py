...
class TestActivationBoundsMixin:
    ...
    def test_no_bounds_returns_true(self):
        ...
        assert executor._is_within_activation_bounds(
            Decimal("100"), TradeType.BUY, OrderType.LIMIT
        ) is True
    ...
    def test_limit_buy_within_bounds(self):
        ...
        assert executor._is_within_activation_bounds(
            Decimal("96"), TradeType.BUY, OrderType.LIMIT
        ) is True
    ...
    def test_limit_buy_outside_bounds(self):
        ...
        assert executor._is_within_activation_bounds(
            Decimal("94"), TradeType.BUY, OrderType.LIMIT
        ) is False
    ...
    def test_limit_sell_within_bounds(self):
        ...
        assert executor._is_within_activation_bounds(
            Decimal("104"), TradeType.SELL, OrderType.LIMIT
        ) is True
    ...
    def test_limit_sell_outside_bounds(self):
        ...
        assert executor._is_within_activation_bounds(
            Decimal("106"), TradeType.SELL, OrderType.LIMIT
        ) is False
    ...
    def test_limit_maker_within_bounds(self):
        ...
        assert executor._is_within_activation_bounds(
            Decimal("96"), TradeType.BUY, OrderType.LIMIT_MAKER
        ) is True
    ...
    def test_market_buy_within_bounds(self):
        ...
        assert executor._is_within_activation_bounds(
            Decimal("100"), TradeType.BUY, OrderType.MARKET
        ) is True
    ...
    def test_market_sell_within_bounds(self):
        ...
        assert executor._is_within_activation_bounds(
            Decimal("100"), TradeType.SELL, OrderType.MARKET
        ) is True
    ...
    def test_limit_buy_exactly_at_boundary(self):
        ...
        assert executor._is_within_activation_bounds(
            Decimal("95"), TradeType.BUY, OrderType.LIMIT
        ) is True
