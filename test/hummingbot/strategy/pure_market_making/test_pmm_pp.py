...
from hummingbot.strategy.pure_market_making.pure_market_making_pp import PureMarketMakingStrategyPurePython
...
class PMMUnitTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.one_level_strategy = PureMarketMakingStrategyPurePython()
        ...
        self.multi_levels_strategy = PureMarketMakingStrategyPurePython()
        ...
        self.order_override_strategy = PureMarketMakingStrategyPurePython()
        ...
        self.custom_price_source_strategy = PureMarketMakingStrategyPurePython()
        ...
        self.split_order_level_strategy = PureMarketMakingStrategyPurePython()
    ...
    def test_basic_one_level_price_type_own_last_trade(self):
        strategy = PureMarketMakingStrategyPurePython()
...
class PureMarketMakingMinimumSpreadUnitTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.strategy: PureMarketMakingStrategyPurePython = PureMarketMakingStrategyPurePython()
